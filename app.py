...
def open_statistics_window(event=None):
    ...
    tk.Label(stats_window, text=f"Nombre Total de Produits : {total_count}", font=("Helvetica", 12), bg="#fefbd8").pack(
        pady=5)
    tk.Label(stats_window, text=f"Codes-Barres Uniques : {unique_codes}", font=("Helvetica", 12), bg="#fefbd8").pack(
        pady=5)
...
entry = tk.Entry(root, validate="key", validatecommand=(validate_command, "%P"), font=("Helvetica", 12), bg="#34495e",
...
label_output = tk.Label(root, text="", font=("Helvetica", 10), bg="#34495e", fg="#ecf0f1")
